 ...
 * the implications!
 */
#define  USB_CFG_DEVICE_ID       0xdb, 0x27 /* = 0x27db = 10203 = keyboard */
 ...
 */
#define USB_CFG_VENDOR_NAME     'b', 'e', 'n', 'r', 'y', 'v', 'e', 's', '.', 'c', 'o', 'm'
 ...
 * details.
 */
#define USB_CFG_DEVICE_NAME     'U', 'S', 'B', ' ', 'R', 'e', 'm', 'o', 't', 'e'
#define USB_CFG_DEVICE_NAME_LEN 10
/* Same as above for the device name. If you don't want a device name, undefine
 * the macros. See the file USB-IDs-for-free.txt before you assign a name if
 * you use a shared VID/PID.
 */
#define USB_CFG_SERIAL_NUMBER   'b', 'e', 'n', 'r', 'y', 'v', 'e', 's', '.', 'c', 'o', 'm', ':', ' ', 'U', 'S', 'B', 'R', 'E', 'M', 'O', 'T', 'E', '0', '1'
